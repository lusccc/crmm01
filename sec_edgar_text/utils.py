...
parser.add_argument('--filings', help='comma-separated list of SEC filings of interest (10-Q,10-K...)', default='10-K,10-Q')
...
parser.add_argument('--report_period', help='search pattern for company report dates, e.g. 2012, 201206 etc.', default='all')
...
def requests_get(url, params=None):
    ...
    hdr = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36'}
